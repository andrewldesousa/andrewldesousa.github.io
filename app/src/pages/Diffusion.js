  ...
  return (
    <div className="page-container">
      <header className="header">
        <h1 className="header__title">Diffusion Model Deep Dive</h1>
        <div className="header__link-section">
          <div className="header__page-link-section">
            <Link to="/" className="header__link">Back</Link>
          </div>   

          <div className="header__icon_link_section">
            <a href="https://www.linkedin.com/in/andrewldesousa/" className="header__icon_link_section__icon_link">
            ...
            <a href="https://github.com/andrewldesousa" className="header__icon_link_section__icon_link">
