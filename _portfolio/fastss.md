...
This project is an Alexa skill that allows for word similarity queries and summarization of recent Reddit posts. The code repository can be found [here](https://github.com/andrewldesousa/FastSS). Our API was deployed with AWS EC2 using the FastAPI library.
