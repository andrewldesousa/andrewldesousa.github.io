...
For this post, I will explain how we can use variational autoencoders to model $p(x)$ where $p(x)$ is a complex distribution.
...
## LVM
Varaiational autoencoders stem from a motivation to decompose a complex distribution $p(x)$ into a product of simpler distributions. 
